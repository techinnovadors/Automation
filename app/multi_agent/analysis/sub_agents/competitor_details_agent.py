...
from ..prompts import COMPETITOR_DETAILS_PROMPT, TARGET_COMPANY_PROFILER_PROMPT
        ...
        async def _safe_profile(
            ...
            async with semaphore:
                ...
                try:
                    ...
                    profile = await self.call(info, user_id, task_session_id)
                    logger.info(
                        f"Semaphore released. Successfully profiled: {info.name}"
                    )
